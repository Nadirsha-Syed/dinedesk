          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className={`w-full bg-slate-950 border ${
                errors.name ? 'border-red-550' : 'border-slate-800 focus:border-violet-500'
              } text-white px-4 py-2.5 rounded-lg focus:outline-none transition duration-150 text-sm`}
            />
            {errors.name && <span className="text-red-450 text-xs font-medium">{errors.name.message}</span>}
          </div>
